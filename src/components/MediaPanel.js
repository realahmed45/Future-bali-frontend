...
import { Upload, Save, LogOut, CheckCircle, Type } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-blue-900">
            ...
            <li>Repeat for all images/videos you want to update</li>
            <li>Click "Save Changes" when finished</li>
            <li>Click "Text Panel" button to manage text content</li>
          </ol>
        </div>
      </div>
    </div>
